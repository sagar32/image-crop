(function() {
  ...
  angular.module("photoSelectDemo")
    .directive("choosePhotoModalDirective", [choosePhotoModalDirective])
    .controller("choosePhotoModalDirectiveController", ["$scope", "$uibModal", "$log", '$location', choosePhotoModalDirectiveController])
    .controller('choosePhotoModalController', ['$scope', "$uibModalInstance", '$uibModal', 'Upload', "$timeout", 'maxWidth', 'ratio', '$window', '$q', choosePhotoModalController]);

  function choosePhotoModalDirective() {
    return {
      scope: {
        onSelectCallback: '&',
        callbackArgs: '=',
  ...
  function choosePhotoModalDirectiveController($scope, $uibModal, $log, $location, onSelectCallback) {
  ...
  function choosePhotoModalController($scope, $uibModalInstance, $uibModal, Upload, $timeout, maxWidth, ratio, $window, $q) {
